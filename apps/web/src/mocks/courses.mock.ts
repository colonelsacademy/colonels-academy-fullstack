...
export const mockCourses: CourseDetail[] = [
  {
    ...
    track: "army",
    summary: "End-to-end officer-cadet prep blending aptitude, military fundamentals, and interview confidence.",
    description: "A guided weekly program covering IQ, GK, and physical readiness for the Nepal Army Officer Cadet selection board.",
    level: "Beginner",
  ...
  },
  {
    ...
    track: "police",
    summary: "Complete inspector-cadet prep covering law, investigation, interview drills, and exam stamina.",
    description: "Guided study plans, mock assessments, and legal-procedure breakdowns for Nepal Police Inspector selection.",
    level: "Intermediate",
