    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-8 text-gray-600 leading-relaxed">
        <section>
          ...
          <p>Welcome to The Colonel&apos;s Academy (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.</p>
        </section>
        ...
        <section>
          <h3 className="text-xl font-bold text-gray-900 mb-3">5. Data Retention and Account Deletion</h3>
          <p>We retain your personal data only for as long as necessary to fulfil the purposes we collected it for. If you wish to permanently delete your account and all associated personal data, please <Link href="/contact" className="text-blue-600 hover:underline font-medium">contact us</Link>.</p>
        </section>
        ...
        <section>
          ...
          <p>If you have any questions about this privacy policy, please contact us at:<br />
            <strong>Email:</strong> support@colonelsacademy.com<br />
