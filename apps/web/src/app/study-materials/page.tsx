...
const MATERIALS = [
  { title: "Nepal Army Officer Cadet Syllabus 2081", type: "PDF", size: "2.4 MB", category: "Army" },
  { title: "Nepal Police Inspector Syllabus 2081", type: "PDF", size: "1.8 MB", category: "Police" },
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-gray-900 font-['Rajdhani'] uppercase mb-3">Study Materials</h1>
        <p className="text-gray-500">Download official syllabi, guides, and preparation materials.</p>
      </div>
