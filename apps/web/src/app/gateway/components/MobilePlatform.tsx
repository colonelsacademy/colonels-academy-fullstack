      ...
      <div className="bg-[#1C1C1E] rounded-[3rem] p-fluid-xl relative overflow-hidden flex flex-col lg:flex-row items-center gap-fluid-lg shadow-2xl">
        ...
        <div className="flex-1 relative z-10 text-center lg:text-left">
          ...
          <p className="text-gray-400 text-fluid-base font-medium leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
            Experience seamless learning. Download lessons for offline access, get instant
            notifications, and track your progress—all from our dedicated mobile app.
          </p>
        ...
        <div className="hidden lg:flex flex-1 relative z-10 justify-end overflow-visible">
          <div className="relative w-[280px] h-[550px] bg-gray-900 rounded-[3rem] border-[8px] border-gray-800 shadow-2xl overflow-hidden ring-1 ring-white/10 fade-in-up">
            {/* Status Bar */}
            ...
            <div className="w-full h-full bg-white overflow-hidden relative flex flex-col pt-0">
              ...
              <div className="flex-1 flex flex-col bg-gray-50 overflow-hidden">
                ...
                <div className="bg-white p-5 pb-0 shadow-sm z-10">
                  <h4 className="text-gray-900 font-bold text-xl leading-tight mb-1 font-['Rajdhani']">
                  ...
                  <div className="flex border-b border-gray-100">
                    <div className="px-1 py-3 text-blue-600 border-b-2 border-blue-600 text-xs font-bold uppercase tracking-wider mr-6 cursor-pointer">
                      Lectures
                    </div>
                    <div className="px-1 py-3 text-gray-400 text-xs font-bold uppercase tracking-wider mr-6 cursor-pointer hover:text-gray-600">
                      Q&A
                    </div>
                    <div className="px-1 py-3 text-gray-400 text-xs font-bold uppercase tracking-wider cursor-pointer hover:text-gray-600">
                      Notes
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3 pb-20">
                  ...
                  {[
                    {
                      title: "1. Introduction to Command",
                      time: "12 mins",
                      playing: false,
                      done: true
                    },
                    {
                      title: "2. Historical Context of War",
                      time: "45 mins",
                      playing: false,
                      done: true
                    },
                    {
                      title: "3. Strategic Assessment",
                      time: "25 mins",
                      playing: true,
                      done: false
                    },
                    ...
                    >
                      <div
                        className={`mt-0.5 w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 ${item.done ? "bg-green-100 text-green-600" : item.playing ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-400"}`}
                      >
                        {item.playing ? (
                      ...
                      <div className="flex-1 min-w-0">
                        <div
                          className={`text-sm font-bold mb-0.5 truncate ${item.playing ? "text-blue-900" : "text-gray-700"}`}
                        >
                          {item.title}
                        </div>
