...
const buildCurriculum = (course: CourseDetail) => [
  {
    title: "Introduction & Orientation",
    lessons: [
      { id: "l1", title: "Lesson 1: Introduction & Orientation Part 1", duration: "16 min", type: "video", isPreview: true, videoId: "" },
      { id: "l2", title: "Lesson 2: Introduction & Orientation Part 2", duration: "17 min", type: "video", isPreview: true, videoId: "" },
      { id: "l3", title: "Lesson 3: Introduction & Orientation Part 3", duration: "18 min", type: "video", isPreview: false, videoId: "" },
    ]
  },
  {
    title: "Core Concepts",
    lessons: [
      { id: "l4", title: "Core Concept 1", duration: "22 min", type: "video", isPreview: false, videoId: "" },
      { id: "l5", title: "Core Concept 2", duration: "18 min", type: "video", isPreview: false, videoId: "" },
      { id: "l6", title: "Core Concept 3", duration: "25 min", type: "video", isPreview: false, videoId: "" },
      { id: "l7", title: "Core Concept 4", duration: "20 min", type: "video", isPreview: false, videoId: "" },
      { id: "l8", title: "Core Concept 5", duration: "15 min", type: "video", isPreview: false, videoId: "" },
      { id: "l9", title: "Core Concept 6", duration: "30 min", type: "video", isPreview: false, videoId: "" },
      { id: "l10", title: "Core Concept 7", duration: "28 min", type: "video", isPreview: false, videoId: "" },
      { id: "l11", title: "Core Concept 8", duration: "19 min", type: "video", isPreview: false, videoId: "" },
    ]
  },
  {
    title: "Advanced Tactics",
    lessons: [
      { id: "l12", title: "Advanced Tactic 1", duration: "35 min", type: "video", isPreview: false, videoId: "" },
      { id: "l13", title: "Advanced Tactic 2", duration: "40 min", type: "video", isPreview: false, videoId: "" },
      { id: "l14", title: "Advanced Tactic 3", duration: "32 min", type: "video", isPreview: false, videoId: "" },
      { id: "l15", title: "Advanced Tactic 4", duration: "28 min", type: "video", isPreview: false, videoId: "" },
      { id: "l16", title: "Advanced Tactic 5", duration: "45 min", type: "video", isPreview: false, videoId: "" },
    ]
  },
  {
    title: "Practical Application",
    lessons: [
      { id: "l17", title: "Practical Session 1", duration: "50 min", type: "video", isPreview: false, videoId: "" },
      { id: "l18", title: "Practical Session 2", duration: "45 min", type: "video", isPreview: false, videoId: "" },
      { id: "l19", title: "Practical Session 3", duration: "55 min", type: "video", isPreview: false, videoId: "" },
      { id: "l20", title: "Practical Session 4", duration: "60 min", type: "video", isPreview: false, videoId: "" },
    ]
  },
];
    ...
    <div className="h-screen flex flex-col bg-white overflow-hidden">
      ...
      <div className="h-14 bg-white text-gray-900 flex items-center justify-between px-4 md:px-6 shadow-sm border-b border-gray-100 z-30 shrink-0 bg-[radial-gradient(circle_at_1px_1px,_rgba(17,24,39,0.06)_1px,_transparent_0)] bg-[size:14px_14px]">
        <div className="flex items-center gap-4">
          <Link href="/courses" className="hover:text-gray-600 transition-colors flex items-center gap-1 text-sm font-bold text-gray-700">
      ...
      <div className="flex-1 flex overflow-hidden">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <ul className="grid md:grid-cols-2 gap-3">
                      {(course.outcomeBullets.length > 0 ? course.outcomeBullets : ["Comprehensive tactical command understanding", "Interview and selection board preparation", "Physical and written exam strategies", "Leadership and decision-making skills"]).map((item, i) => (
              ...
              {activeTab === "resources" && (
                <div className="space-y-3">
                  ...
                  <div className="p-4 border rounded-lg flex items-center justify-between hover:bg-gray-50 cursor-pointer transition-colors">
                    ...
                    <button type="button" className="text-sm font-bold text-blue-600 hover:underline">Download</button>
                  </div>
                </div>
              )}
            </div>
        ...
        >
          <div className="flex items-center justify-between p-4 border-b border-gray-100 bg-gray-50/50">
            <span className="font-bold text-sm uppercase tracking-wider text-gray-700">Course Content</span>
          </div>
              ...
              <div key={moduleIndex} className="border-b border-gray-100">
                ...
                >
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-medium mt-0.5">{module.lessons.length} Lessons</p>
                  </div>
