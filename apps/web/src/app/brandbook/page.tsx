    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-[clamp(3rem,10vw,8rem)] font-black text-white tracking-tighter mb-8 font-['Rajdhani'] leading-none">
              FORGING{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F4CA30]">
                FUTURE
              </span>
              <br />
              LEADERS
            ...
            <p className="max-w-2xl mx-auto text-gray-400 text-lg font-medium leading-relaxed mb-12">
              The definitive guide to the visual and verbal soul of Colonel&apos;s Academy. A system
              built for elite performance and prestige.
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2">
              <span className="text-[#D4AF37] font-black text-[11px] uppercase tracking-[0.25em] mb-4 block">
                Section 01
              </span>
              <h2 className="text-5xl font-bold text-[#0B1120] mb-8 font-['Rajdhani'] uppercase tracking-tight">
                The Core Mark
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-10">
                Our logo is a symbol of authority, resilience, and growth. It blends modern
                geometric precision with traditional military honor. The shield represents
                protection, while the internal insignia denotes specialized expertise.
              </p>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                  <h4 className="font-bold text-sm text-[#0B1120] mb-2">Safe Zone</h4>
                  <p className="text-xs text-gray-500">
                    Minimum 40px clear space around all sides of the mark.
                  </p>
                </div>
                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                  <h4 className="font-bold text-sm text-[#0B1120] mb-2">Contrast</h4>
                  <p className="text-xs text-gray-500">
                    Must maintain 4.5:1 ratio on any background.
                  </p>
                </div>
              </div>
            </div>
            <div className="lg:w-1/2 w-full aspect-square bg-gray-50 rounded-[3rem] flex items-center justify-center relative overflow-hidden group">
              ...
              <div className="relative z-10 text-center transition-transform duration-700 group-hover:scale-110">
                ...
                <p className="text-[#0B1120] group-hover:text-white font-black uppercase tracking-[0.2em] text-xs transition-colors">
                  Primary Brand Mark
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex items-center justify-between bg-red-50 border border-red-100 rounded-xl px-5 py-4">
                  ...
                  <span className="text-sm text-red-700">
                    Place on busy photos without contrast.
                  </span>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-[#F8F9FB]">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="text-5xl font-bold text-[#0B1120] mb-6 font-['Rajdhani'] uppercase tracking-tight">
              Spectral Authority
            </h2>
            <p className="text-gray-600 text-lg">
              Our palette is curated to evoke discipline, prestige, and tactical clarity.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h4 className="text-xl font-bold text-[#0B1120] mb-2 font-['Rajdhani']">
                MAINSTAY NAVY
              </h4>
              <p className="text-sm text-gray-500 mb-6">
                #0B1120 | The foundation of our digital trust.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-20">
            <div className="lg:w-1/3">
              ...
              <h2 className="text-4xl font-bold text-[#0B1120] mb-8 font-['Rajdhani'] uppercase tracking-tight">
                The Typeface
              </h2>
              <p className="text-gray-600 leading-relaxed mb-8">
                Typography is as important as the words themselves. We use a combination of
                technical precision and readable elegance.
              </p>
            </div>
            <div className="lg:w-2/3 space-y-12">
              <div className="p-12 bg-gray-50 rounded-[2rem] border border-gray-100 overflow-hidden relative">
                <div className="absolute right-[-5%] top-[-10%] text-[15rem] font-black text-[#0B1120]/[0.03] pointer-events-none select-none">
                  Aa
                </div>
                <h3 className="text-sm font-black text-blue-600 uppercase tracking-widest mb-6">
                  Display Font: Rajdhani
                </h3>
                <div className="space-y-4 font-['Rajdhani']">
                  <p className="text-[clamp(3rem,8vw,6rem)] font-bold text-[#0B1120] leading-none tracking-tighter">
                    ABCDEFG
                  </p>
                  <p className="text-[clamp(3rem,8vw,6rem)] font-light text-[#0B1120] leading-none tracking-tighter">
                    hijklmnop
                  </p>
                  <p className="text-2xl font-medium text-gray-500 mt-8 tracking-[0.1em]">
                    THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG
                  </p>
                </div>
              </div>
              <div className="p-12 bg-[#0B1120] rounded-[2rem] text-white overflow-hidden relative">
                <div className="absolute right-[-5%] top-[-10%] text-[15rem] font-black text-white/[0.03] pointer-events-none select-none">
                  Bb
                </div>
                <h3 className="text-sm font-black text-amber-400 uppercase tracking-widest mb-6">
                  Body Font: Sans-Serif / Inter
                </h3>
                <div className="space-y-6">
                  <p className="text-3xl font-bold leading-tight">
                    Elite preparation for the nation&apos;s most prestigious careers.
                  </p>
                  <p className="text-lg text-gray-400 leading-relaxed max-w-xl text-justify">
                    Designed for readability and professional tone. Whether it&apos;s a course
                    description or an IQ training manual, the choice of font ensures our cadets
                    focus on what matters most: excellence.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-32 bg-[#F8F9FB] border-y border-gray-100">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-gray-600 text-lg">
              Core UI building blocks with consistent shape, tone, and behavior.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="bg-white rounded-[2rem] border border-gray-100 p-10 shadow-sm">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  type="button"
                  className="px-6 py-3 bg-[#0B1120] text-white text-xs font-black uppercase tracking-[0.2em] rounded-xl"
                >
                  Primary
                </button>
                <button
                  type="button"
                  className="px-6 py-3 bg-white border border-gray-200 text-[#0B1120] text-xs font-black uppercase tracking-[0.2em] rounded-xl"
                >
                  Secondary
                </button>
                <button
                  type="button"
                  className="px-6 py-3 bg-transparent text-[#0B1120] text-xs font-black uppercase tracking-[0.2em] rounded-xl"
                >
                  Ghost
                </button>
                <button
                  type="button"
                  className="px-6 py-3 bg-gray-200 text-gray-400 text-xs font-black uppercase tracking-[0.2em] rounded-xl cursor-not-allowed"
                >
                  Disabled
                </button>
              </div>
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 p-10 shadow-sm">
              ...
              <div className="rounded-2xl border border-gray-200 overflow-hidden bg-white shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <div className="text-lg font-bold text-[#0B1120] mb-2 font-['Rajdhani']">
                    Cadet Officer Prep
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      className="px-4 py-2 bg-[#0B1120] text-white text-[10px] font-black uppercase tracking-widest rounded-lg"
                    >
                      Enroll
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 p-10 shadow-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="px-3 py-1 bg-[#eceb98] text-[#3d3c0a] text-[10px] font-black uppercase tracking-widest rounded-full">
                  Bestseller
                </span>
                <span className="px-3 py-1 bg-[#f3ca8c] text-[#593d00] text-[10px] font-black uppercase tracking-widest rounded-full">
                  Premium
                </span>
            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 p-10 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between px-4 py-3 rounded-xl bg-emerald-50 border border-emerald-100 text-emerald-700 text-xs font-bold">
                  ...
                  <span className="text-[10px] uppercase tracking-widest">Success</span>
                </div>
                <div className="flex items-center justify-between px-4 py-3 rounded-xl bg-amber-50 border border-amber-100 text-amber-700 text-xs font-bold">
                  ...
                  <span className="text-[10px] uppercase tracking-widest">Warning</span>
                </div>
      ...
      <section className="py-32 bg-[#F8F9FB] overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-gray-600 text-lg">
              Applied design samples demonstrating the brand in action.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <h4 className="text-xs font-black uppercase tracking-widest text-gray-400 px-4">
                Sample: Tactical Course Card
              </h4>
              <div className="bg-white rounded-[2rem] overflow-hidden shadow-2xl border border-gray-100 group">
                ...
                <div className="p-10">
                  <div className="flex gap-2 mb-4">
                    ...
                    <span className="px-2 py-0.5 bg-amber-100 text-amber-700 text-[9px] font-black uppercase tracking-widest rounded">
                      Bestseller
                    </span>
                  </div>
                  <h3 className="text-2xl font-bold text-[#0B1120] mb-3 font-['Rajdhani']">
                    Officer Cadet Excellence
                  </h3>
                  <p className="text-gray-500 text-sm mb-8 line-clamp-2">
                    Complete tactical and psychological preparation for the Nepal Army selection
                    process.
                  </p>
                  <div className="flex items-center justify-between border-t border-gray-100 pt-6">
                    ...
                    <button
                      type="button"
                      className="bg-[#0B1120] text-white px-6 py-2.5 rounded-lg text-xs font-bold uppercase tracking-widest"
                    >
                      Enroll Now
                    </button>
                  </div>
                ...
                {[
                  {
                    ...
                    text: "Every detail of our platform is designed with mathematical and tactical accuracy."
                  },
                  {
                    icon: Award,
                    title: "Absolute Quality",
                    text: "Only the top 1% of instructors make it to our directing staff."
                  },
                  {
                    icon: Users,
                    title: "Cadet First",
                    text: "Our success is measured solely by the rank of our graduates."
                  }
                ].map((item) => (
                  <div
                    key={item.title}
                    className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg flex gap-6 items-start hover:shadow-xl transition-shadow"
                  >
                    <div className="p-4 bg-gray-50 rounded-xl">
                      <item.icon className="w-6 h-6 text-[#0B1120]" />
                    </div>
                    <div>
                      <h5 className="font-bold text-[#0B1120] text-lg mb-1 font-['Rajdhani'] uppercase tracking-wide">
                        {item.title}
                      </h5>
      ...
      <section className="py-24 bg-[#0B1120] text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-5xl font-black mb-8 font-['Rajdhani'] tracking-tight">
            READY TO DEPLOY THE BRAND?
          </h2>
          <p className="text-gray-400 mb-12 max-w-xl mx-auto">
            This design system is a living document. It evolves with our mission. Always refer to
            these guidelines for any creative output.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <button
              type="button"
              className="px-12 py-4 bg-white text-[#0B1120] font-black uppercase tracking-[0.2em] text-sm rounded-xl hover:bg-blue-50 transition-all flex items-center justify-center gap-3"
            >
            ...
            <button
              type="button"
              className="px-12 py-4 bg-white/5 border border-white/20 text-white font-black uppercase tracking-[0.2em] text-sm rounded-xl hover:bg-white/10 transition-all"
            >
              Request Support
            </button>
          </div>
