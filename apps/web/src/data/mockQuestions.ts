...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answer: "C",
    explanation: "Rifle/round, rocket/launcher are weapon + ammo pairs. Gun and shell also fit — but 'tank and gun' doesn't follow the same pattern. The odd pair is gun and shell (gun fires shells, not specifically 'shell' ammo type).",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: ["5", "6", "8", "9"],
    answer: "D",
    explanation: "Pattern: top number = bottom-left + bottom-right − something. R = 49 + 32 − 72 = 9.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer: "C",
    explanation: "West is opposite East; going clockwise 90° from West gives NorthEast. Same logic: South → NorthWest.",
  },
  {
    id: 38,
