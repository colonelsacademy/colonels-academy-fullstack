...
export default function CourseDetailsScreen() {
  ...
  const course = {
    ...
    tag: "NEPAL ARMY",
    heroImageUrl: "https://uat.thecolonelsacademy.com/images/courses/nepal-army-staff-college.png?w=800&q=85",
    rating: 4.9,
    ratingCount: 4250,
    students: 2450,
    duration: "60 Hours",
            ...
            <View style={styles.headerContent}>
              ...
              <View style={styles.stats}>
                <View style={styles.stat}>
                  ...
                  <Text style={styles.statText}>{course.rating} ({course.ratingCount.toLocaleString()})</Text>
                </View>
                <View style={styles.stat}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.instructor}>
              <Image
                source={{ uri: "https://uat.thecolonelsacademy.com/images/instructors/Rajesh%20Thapa.png" }}
            ...
            {curriculum.map((module, moduleIndex) => (
              <View key={moduleIndex} style={styles.module}>
                <TouchableOpacity
                  ...
                  onPress={() => setExpandedModule(expandedModule === moduleIndex ? null : moduleIndex)}
                >
