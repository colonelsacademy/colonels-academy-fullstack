...
import { Target, Play, X, Star } from "lucide-react-native";
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity 
              ...
              activeOpacity={0.9}
            >
              <Image source={{ uri: item.image }} style={styles.instructorImage} resizeMode="cover" />
              <View style={styles.instructorInfo}>
                ...
                <View style={styles.instructorStats}>
                  ...
                  <View style={styles.instructorStat}>
                    ...
                    <Text style={styles.instructorStatText}>{(item.students / 1000).toFixed(1)}K</Text>
                  </View>
                </View>
              </View>
            </TouchableOpacity>
                ...
                <View style={styles.modalContent}>
                  <View style={styles.modalHeader}>
                    ...
                    <View style={styles.modalRating}>
                      <Star size={14} fill={Colors.accent.gold} color={Colors.accent.gold} strokeWidth={2} />
                  ...
                  <View style={styles.modalStats}>
                    <View style={styles.modalStatItem}>
                      <Text style={styles.modalStatValue}>{selectedInstructor.students.toLocaleString()}</Text>
