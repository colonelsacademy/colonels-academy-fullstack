...
export const courseCatalog: CourseDetail[] = [
  {
    ...
    accentColor: "#5E6B3C",
    heroImageUrl: "/images/courses/staff-college-command.png",
    featured: true,
    isComingSoon: false,
    format: "hybrid",
    liveSupport:
  ...
  },
  {
    ...
    accentColor: "#224785",
    heroImageUrl: "/images/courses/police-inspector-cadet.png",
    featured: true,
    isComingSoon: false,
    format: "cohort",
  ...
  },
  {
    ...
    accentColor: "#B6762C",
    heroImageUrl: "/images/courses/apf-inspector-cadet.png",
    featured: true,
    isComingSoon: false,
    format: "hybrid",
  ...
  },
  {
    ...
    originalPriceNpr: 7000,
    accentColor: "#8F7A38",
    heroImageUrl: "/images/courses/officer-cadet-elite.png",
    isComingSoon: false,
    format: "cohort",
  ...
  },
  {
    ...
    accentColor: "#8C4136",
    heroImageUrl: "/images/courses/mission-english-ops.png",
    isComingSoon: false,
    format: "self-paced",
